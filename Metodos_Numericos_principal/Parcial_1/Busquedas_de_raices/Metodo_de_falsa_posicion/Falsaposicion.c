...
int main()
{
	...
	printf("\nEste método es para encontrar la raíz de aproximada de la ecuaciones no lineales.\n");	
	printf("Introduce un rango en donde cree que puede haber una solución de la función.\n");
	scanf("%f", &x0);
	scanf("%f", &x1);
	...
	if(f1 * f1 > tol * tol)
		printf("\nNo se ha encontrado ningúna solución o hay mas de dos soluciones, intente con otro rango");
	else
